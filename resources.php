    ...
    <main>
        <section class="resources-section">
            ...
            <div class="filter-container">
                <a href="resources.php?search=<?php echo urlencode($search_query); ?>&filter=all"
                    class="chip <?php echo $filter == 'all' ? 'active' : ''; ?>">All</a>
                <a href="resources.php?search=<?php echo urlencode($search_query); ?>&filter=book"
                    class="chip <?php echo $filter == 'book' ? 'active' : ''; ?>">Books</a>
                <a href="resources.php?search=<?php echo urlencode($search_query); ?>&filter=note"
                    class="chip <?php echo $filter == 'note' ? 'active' : ''; ?>">Notes</a>
                <a href="resources.php?search=<?php echo urlencode($search_query); ?>&filter=question"
                    class="chip <?php echo $filter == 'question' ? 'active' : ''; ?>">Questions</a>
            </div>
                    ...
                    while ($resource = $result_resources->fetch_assoc()) {
                        ...
                        <div class="resource-card">
                            ...
                            <div class="resource-info">
                                ...
                                <a href="<?php echo isUserLoggedIn() ? 'download.php?file=' . urlencode($file_path) . '&type=' . urlencode(strtolower($type)) : 'signin.php'; ?>"
                                    class="download-btn">
